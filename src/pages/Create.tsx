                ...
                return (
                    <div className="space-y-6 animate-fade-in pb-10">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <label className="text-sm font-medium flex items-center">
                                    <Calendar className="h-4 w-4 mr-2" /> {t('date')}<span className="text-primary-500 ml-0.5 font-bold">*</span>
                                </label>
                                <Input
                                    type="date"
                                    value={data.date}
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium flex items-center">
                                    <Clock className="h-4 w-4 mr-2" /> {t('time')}<span className="text-primary-500 ml-0.5 font-bold">*</span>
                                </label>
                                <Input
                                    type="time"
                                    value={data.time}
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative" ref={musicListRef}>
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-between h-11 px-3 rounded-md border border-gold-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm hover:border-pink-300"
                                >
                                        ...
                                        <div className="p-2 space-y-1">
                                            {MUSIC_OPTIONS_KEYS.map((music) => (
                                                <div
                                                    ...
                                                    className={cn(
                                                        "flex items-center justify-between p-3 rounded-xl cursor-pointer group",
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium flex items-center">
                                <MessageSquare className="h-4 w-4 mr-2" /> {t('message')}<span className="text-primary-500 ml-0.5 font-bold">*</span>
                            </label>
                            <textarea
