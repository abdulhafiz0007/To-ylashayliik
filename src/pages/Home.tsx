        ...
        <div className="flex flex-col space-y-12 pb-12">
            ...
            <section className="relative py-20 px-4 text-center overflow-hidden">
                ...
                <div className="container mx-auto max-w-4xl space-y-6">
                    <h1 className="font-serif text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary-700 via-primary-500 to-gold-600 dark:from-primary-400 dark:to-gold-400 animate-slide-up">
                        {t('heroTitle')}
                    </h1>
                    <p className="text-xl md:text-2xl text-gold-800 dark:text-gold-200 max-w-2xl mx-auto font-light animate-fade-in delay-100">
                        {t('heroSubtitle')}
                    </p>
